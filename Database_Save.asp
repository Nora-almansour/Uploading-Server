...
RecordSet.Fields("FileName").Value = Upload.Fields("FileName").FileName
RecordSet.Fields("FileSize").Value = Upload.Fields("FileName").Length
RecordSet.Fields("ContentType").Value = Upload.Fields("FileName").ContentType
RecordSet.Fields("BinaryData").AppendChunk Upload("FileName").BLOB & ChrB(0)
